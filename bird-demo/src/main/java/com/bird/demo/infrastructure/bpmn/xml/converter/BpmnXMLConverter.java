...
import com.bird.demo.infrastructure.bpmn.xml.converter.alfresco.AlfrescoStartEventXMLConverter;
import com.bird.demo.infrastructure.bpmn.xml.converter.alfresco.AlfrescoUserTaskXMLConverter;
import com.bird.demo.infrastructure.bpmn.xml.converter.child.DocumentationParser;
import com.bird.demo.infrastructure.bpmn.xml.converter.child.IOSpecificationParser;
import com.bird.demo.infrastructure.bpmn.xml.converter.child.MultiInstanceParser;
import com.bird.demo.infrastructure.bpmn.xml.converter.export.*;
import com.bird.demo.infrastructure.bpmn.xml.converter.parser.*;
import com.bird.demo.infrastructure.bpmn.xml.converter.util.BpmnXMLUtil;
import com.bird.demo.infrastructure.bpmn.xml.exception.XMLException;
...
public class BpmnXMLConverter implements BpmnXMLConstants {
    ...
    protected static final String BPMN_XSD = "cn/tongdun/demo/bpmn/xml/parser/BPMN20.xsd";
