...
public class FlowableMapExceptionParser extends BaseChildElementParser {
    ...
    public void parseChildElement(XMLStreamReader xtr, BaseElement parentElement, BpmnModel model) throws Exception {
        ...
        String errorCode = xtr.getAttributeValue(null, BpmnXMLConstants.MAP_EXCEPTION_ERRORCODE);
        String andChildren = xtr.getAttributeValue(null, BpmnXMLConstants.MAP_EXCEPTION_ANDCHILDREN);
        String rootCause = xtr.getAttributeValue(null, BpmnXMLConstants.MAP_EXCEPTION_ROOTCAUSE);
