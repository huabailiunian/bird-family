    ...
    public void parseChildElement(XMLStreamReader xtr, BaseElement parentElement, BpmnModel model) throws Exception {
        ...
        try {
            while (!readyWithIOSpecification && xtr.hasNext()) {
                xtr.next();
                if (xtr.isStartElement() && BpmnXMLConstants.ELEMENT_DATA_INPUT.equalsIgnoreCase(xtr.getLocalName())) {
                    DataSpec dataSpec = new DataSpec();
                    BpmnXMLUtil.addXMLLocation(dataSpec, xtr);
                    dataSpec.setId(xtr.getAttributeValue(null, BpmnXMLConstants.ATTRIBUTE_ID));
                    dataSpec.setName(xtr.getAttributeValue(null, BpmnXMLConstants.ATTRIBUTE_NAME));
                    dataSpec.setItemSubjectRef(parseItemSubjectRef(xtr.getAttributeValue(null, BpmnXMLConstants.ATTRIBUTE_ITEM_SUBJECT_REF), model));
                    ioSpecification.getDataInputs().add(dataSpec);

                } else if (xtr.isStartElement() && BpmnXMLConstants.ELEMENT_DATA_OUTPUT.equalsIgnoreCase(xtr.getLocalName())) {
                    DataSpec dataSpec = new DataSpec();
                    BpmnXMLUtil.addXMLLocation(dataSpec, xtr);
                    dataSpec.setId(xtr.getAttributeValue(null, BpmnXMLConstants.ATTRIBUTE_ID));
                    dataSpec.setName(xtr.getAttributeValue(null, BpmnXMLConstants.ATTRIBUTE_NAME));
                ...
                } else if (xtr.isStartElement() && BpmnXMLConstants.ELEMENT_DATA_INPUT_REFS.equalsIgnoreCase(xtr.getLocalName())) {
                ...
                } else if (xtr.isStartElement() && BpmnXMLConstants.ELEMENT_DATA_OUTPUT_REFS.equalsIgnoreCase(xtr.getLocalName())) {
