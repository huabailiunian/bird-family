...
public class MessageEventDefinitionParser extends BaseChildElementParser {
    ...
    public void parseChildElement(XMLStreamReader xtr, BaseElement parentElement, BpmnModel model) throws Exception {
        ...
        eventDefinition.setMessageRef(xtr.getAttributeValue(null, BpmnXMLConstants.ATTRIBUTE_MESSAGE_REF));
        eventDefinition.setMessageExpression(BpmnXMLUtil.getAttributeValue(BpmnXMLConstants.ATTRIBUTE_MESSAGE_EXPRESSION, xtr));
