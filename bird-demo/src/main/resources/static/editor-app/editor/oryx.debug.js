...
ORYX = Object.extend(ORYX, {
	 ...
	 * preliminary drl is not met has to fail with an error.
	 */
	load: function() {
			...
			onSuccess: function(result) {
				...
				preferences.each( function(p) {
					...
					props.each( function(prop) {
						...
						// get all attributes from the node and set to globals properties
...
ORYX.Editor = {
	...
	// Defines the globals dom event listener
