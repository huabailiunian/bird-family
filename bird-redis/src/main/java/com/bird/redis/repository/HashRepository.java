 ...
 */
public interface HashRepository<V,F> extends KeyRepository<String> {
     ...
     */
    V hGet(final String key, F field);
...
//    T hGetWithCache(final String key, F field);
     ...
     */
    Map<String, V> hMGet(final String key, final Set<F> fields);
...
//    Map<String, T> hMGetWithCache(final String key, final Set<F> fields);
     ...
     */
    boolean hSet(final String key, F field, V value);
     ...
     * @param values
     */
    void hMSet(String key, Map<F, V> values);
     ...
     * @return
     */
    Set<Map.Entry<String, V>> hEntrySet(final String key);
     ...
     * @return
     */
    Map<String, V> hGetAll(final String key);
}
